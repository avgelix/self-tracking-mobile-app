...
import { Category, Reminder, ReminderFrequency, NotificationType, NotificationSound, NotificationPrivacy, CustomFrequency } from '../types';
...
interface CategoryReminderManagerProps {
  category: Category;
  isOpen: boolean;
  onClose: () => void;
}

export function CategoryReminderManager({ category, isOpen, onClose }: CategoryReminderManagerProps) {
  ...
  // Filter reminders for this category only
  const categoryReminders = state.reminders.filter(r => r.categoryId === category.id);
      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-3">
            ...
            Manage Reminders for {category.name}
          </DialogTitle>
          <DialogDescription>
            Set up notifications to help you track data consistently for this category
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <Badge variant="secondary">{categoryReminders.length} reminders</Badge>
              <Badge variant="outline">{categoryReminders.filter(r => r.isActive).length} active</Badge>
            </div>
            <Button
              ...
              <Card className="text-center py-8">
                <CardContent>
                  ...
                  <p className="text-muted-foreground mb-4">
                    Create your first reminder to stay on track with tracking {category.name}
                  </p>
                </CardContent>
              </Card>
            ) : (
        ...
        <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                Set up a reminder for {category.name}
              </DialogDescription>
            </DialogHeader>
            ...
            <Tabs defaultValue="basic" className="space-y-4">
              ...
              <TabsContent value="basic" className="space-y-4">
                <div className="space-y-2">
                  ...
                  <Input
                    id="reminder-name"
                    placeholder={`e.g., Daily ${category.name} Check`}
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="__general__">General reminder for {category.name}</SelectItem>
